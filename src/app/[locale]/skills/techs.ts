...
export const techs = [
  { id: "typescript", name: "TypeScript", icon: "/typescript.svg", level: 92, years: 5 },
  { id: "javascript", name: "JavaScript", icon: "/javascript.svg", level: 92, years: 5 },
  ...
  { id: "angular", name: "Angular", icon: "/angular.svg", level: 74, years: 2 },
  { id: "vue", name: "Vue.js", icon: "/vue.svg", level: 79, years: 3 },
  { id: "express", name: "Express.js", icon: "/express-js.svg", level: 81, years: 5 },
  { id: "nest", name: "Nest.js", icon: "/nest.svg", level: 80, years: 2 },
  { id: "git", name: "Git", icon: "/git.svg", level: 85, years: 5 },
  { id: "docker", name: "Docker", icon: "/docker.svg", level: 88, years: 5 },
  { id: "php", name: "PHP", icon: "/php.svg", level: 67, years: 1.5 },
  { id: "java", name: "Java", icon: "/java.svg", level: 67, years: 3 },
  ...
  { id: "sql", name: "SQL", icon: "/sql.svg", level: 83, years: 5 },
  { id: "mongodb", name: "MongoDB", icon: "/mongodb.svg", level: 85, years: 3 },
  { id: "jquery", name: "jQuery", icon: "/jquery.svg", level: 90, years: 5 },
  { id: "graphql", name: "GraphQL", icon: "/graphql.svg", level: 78, years: 4 },
].map(tech => ({
  ...tech,
